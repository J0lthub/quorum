...
Quorum uses Dolt as its database. This document explains why an architectural one that which shaped how the system works.
...
2. Separate tables per agent cause you to lose relational integrity, make queries painful, and still provide no commit history.
